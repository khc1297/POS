...
public class CoffeShopManagementSystemJFrame extends javax.swing.JFrame {

	/**
	 * Creates new form CoffeShopManagementSystemJFrame
	 */
	...
	private void initComponents() {
		 ...
		 * 
		 */
		rm_jButton_search_reservation = new javax.swing.JButton();
		rm_jButton_cansel_reservation = new javax.swing.JButton();
		rm_jButton_window_reservation = new javax.swing.JButton();
		rm_jLabel1 = new javax.swing.JLabel();
		rm_jLabel2 = new javax.swing.JLabel();
		rm_jLabel3 = new javax.swing.JLabel();
		rm_JTextfield_window = new javax.swing.JTextField();
		//
														...
														.addGroup(
																member_management_jPanelLayout
																		...
																		.addPreferredGap(
																				javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
																		.addComponent(
																				mm_jButton_search_member,		//고객정보검색
																				javax.swing.GroupLayout.PREFERRED_SIZE,
																				120,
																				javax.swing.GroupLayout.PREFERRED_SIZE)))
										.addGroup(
																		...
																		.addGroup(
																				member_management_jPanelLayout
																						.createParallelGroup(
																								javax.swing.GroupLayout.Alignment.LEADING)
																						.addComponent(
																								mm_jTextField_member_birth,		//생일
																								javax.swing.GroupLayout.PREFERRED_SIZE,
																								100,
																								javax.swing.GroupLayout.PREFERRED_SIZE)
																						.addComponent(
																								mm_jTextField_member_name,		//고객명
																								javax.swing.GroupLayout.PREFERRED_SIZE,
																								100,
																								javax.swing.GroupLayout.PREFERRED_SIZE)))
														.addGroup(
																member_management_jPanelLayout
																		...
																		.addPreferredGap(
																				javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
																		.addComponent(
																				mm_jButton_delete_member,		//고객정보삭제
																				javax.swing.GroupLayout.PREFERRED_SIZE,
																				120,
																				javax.swing.GroupLayout.PREFERRED_SIZE)
																		.addPreferredGap(
		...
		rm_jButton_search_reservation.setText("예약조회");
		rm_jButton_search_reservation
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
						rm_jButton_search_reservationActionPerformed(evt);
					}
				});

		rm_jButton_cansel_reservation.setText("예약취소");
		rm_jButton_cansel_reservation
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
						rm_jButton_cansel_reservationActionPerformed(evt);
					}
				});

		rm_jButton_window_reservation.setText("예약화면");
		rm_jButton_window_reservation
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
						rm_jButton_window_reservationActionPerformed(evt);
					}
				});
		//년 월 일 콤보박스 설정
		rm_jLabel1.setText("년");
		rm_jLabel1.setBounds(80,315, 100, 100);
		rm_jLabel2.setText("월");
		rm_jLabel2.setBounds(160,315, 100, 100);
		rm_jLabel3.setText("일");
		rm_jLabel3.setBounds(240,315, 100, 100);
		rm_jComboBox_year.setBounds(10, 350, 70, 30);
		reserve_management_jPanel.add(rm_jComboBox_year);
		rm_jComboBox_month.setBounds(90, 350, 70, 30);
		reserve_management_jPanel.add(rm_jComboBox_month);
		rm_jComboBox_day.setBounds(170, 350, 70, 30);
		reserve_management_jPanel.add(rm_jComboBox_day);
		reserve_management_jPanel.add(rm_jLabel1);
		reserve_management_jPanel.add(rm_jLabel2);
		reserve_management_jPanel.add(rm_jLabel3);
		...
		//버튼들
		reserve_management_jPanel.add(rm_jButton_search_reservation);
		reserve_management_jPanel.add(rm_jButton_cansel_reservation);
		reserve_management_jPanel.add(rm_jButton_window_reservation);
		reserve_management_jPanel.add(pane);
		reserve_management_jPanel.setLayout(null);
		
		rm_jButton_search_reservation.setBounds(250,350,100,30);
		rm_jButton_cansel_reservation.setBounds(350,350,100,30);
		rm_jButton_window_reservation.setBounds(450,350,100,30);
		
		spinner.setBounds(20, 350, 100, 30);
		pane.setBounds(30, 30, 500, 300);
	...
	//예약조회 버튼(관리자 모드)
	private void rm_jButton_search_reservationActionPerformed(
		...
		for(int i = 0 ; i < tmp3.size(); i++)
		{
			if(month.equals(tmp3.get(i).getmonth()) && day.equals(tmp3.get(i).getDay()) && year.equals(tmp3.get(i).getyear()))
			{
				...
				v.addElement(tmp3.get(i).getPhone());
				model2.addRow(v);
			}
		}
	...
	//예약취소 버튼(관리자모드)
	private void rm_jButton_cansel_reservationActionPerformed(
			java.awt.event.ActionEvent evt){
		...
		try{
			...
			int Day = Integer.parseInt(day);
				...
				for (int i : items) {
					...
					String phone = (String) model2.getValueAt(i, 2);
					Data data = new Data();
					tmp =(int) Data.updatecanselInfo(data,seats,name,phone);
					 if(YEAR > Year || (YEAR == Year && MONTH > Month) || (YEAR == Year && MONTH == Month && DATE > Day))
							{
						 		if(name.equals("--"))
						 		{
						 			JOptionPane.showMessageDialog(null, "예약되어 있지 않습니다.");
						 			break;
						 		}
						 		else{
					...
					if(name.equals("--"))
						...
						JOptionPane.showMessageDialog(null,"예약취소가 성공되었습니다.");
				}
				}catch (Exception err) {
	...
	//예약화면 버튼
	private void rm_jButton_window_reservationActionPerformed(
				java.awt.event.ActionEvent evt){
		new Thread(){
			public void run(){
				New dialog = new New();
	...
	private javax.swing.JButton rm_jButton_search_reservation;
	private javax.swing.JButton rm_jButton_cansel_reservation;
	private javax.swing.JButton rm_jButton_window_reservation;
	...
	private javax.swing.JTextField rm_JTextfield_window;
	private javax.swing.JPanel reserve_management_jPanel;
	private javax.swing.SpinnerModel model;
	private javax.swing.JSpinner spinner;
	private DefaultTableModel model2;
	private JTable table;
	private javax.swing.JLabel rm_jLabel1;
	private javax.swing.JLabel rm_jLabel2;
	private javax.swing.JLabel rm_jLabel3;
